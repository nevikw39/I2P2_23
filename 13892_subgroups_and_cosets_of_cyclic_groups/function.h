...
public:
    ...
    CyclicGroup(const set<int> &s, int e) : S(s), E(e) {} // Note tha6 const memeber must be initialized by initilizer list!!
...
public:
    int operator()(int, int) const;                   // TODO: Implement addition of integers under modulus of N
    int inverse(int x) const { return (-x + N) % N; } // Return the inverse to a particular element
    ...
    ModularAdditiveGroup *generate_subgroup(int) const; // TODO: Generate the subgroup by a particular element
...
public:
    int operator()(int, int) const; // TODO: Implement multiplication of integers under modulus of N
    int inverse(int x) const        // Return the inverse to a particular element
    ...
    PrimeModularMultiplicativeGroup *generate_subgroup(int) const; // TODO: Generate the subgroup by a particular element
                                                                   //       Since it's a polymorphic class, you should return something `new`ed!
};
...
ModularAdditiveGroup *ModularAdditiveGroup::generate_subgroup(int g)
{
    // ...
    return new // ...
}
...
// TODO:
// Generate the subgroup by a particular element
PrimeModularMultiplicativeGroup *PrimeModularMultiplicativeGroup::generate_subgroup(int g)
{
    // ...
    return new // ...;
}
...
set<int> coset(int g, CyclicGroup *H)
{
    // ...
}
